package org.uboot.modules.quartz.service.impl;

import java.util.List;

import org.uboot.common.constant.CommonConstant;
import org.uboot.common.exception.UBootException;
import org.uboot.modules.quartz.entity.QuartzJob;
import org.uboot.modules.quartz.mapper.QuartzJobMapper;
import org.uboot.modules.quartz.service.IQuartzJobService;
...
public class QuartzJobServiceImpl extends ServiceImpl<QuartzJobMapper, QuartzJob> implements IQuartzJobService {
	...
	private void schedulerAdd(String jobClassName, String cronExpression, String parameter) {
		try {
			...
			throw new UBootException("创建定时任务失败", e);
		} catch (RuntimeException e) {
			throw new UBootException(e.getMessage(), e);
		}catch (Exception e) {
			throw new UBootException("后台找不到该类名：" + jobClassName, e);
		}
	}
	...
	private void schedulerDelete(String jobClassName) {
		try {
			...
			throw new UBootException("删除定时任务失败");
		}
	}
