package org.uboot.modules.message.job;

import java.util.List;

import org.uboot.common.util.DateUtils;
import org.uboot.modules.message.entity.SysMessage;
import org.uboot.modules.message.handle.ISendMsgHandle;
import org.uboot.modules.message.handle.enums.SendMsgStatusEnum;
import org.uboot.modules.message.handle.enums.SendMsgTypeEnum;
...
public class SendMsgJob implements Job {
	...
	public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		...
		log.info(String.format(" UBoot 发送消息任务 SendMsgJob !  时间:" + DateUtils.getTimestamp()));
