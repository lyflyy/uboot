package org.uboot.common.util.jsonschema;
...
public class JsonschemaUtil {
	...
	public static JSONObject getJsonSchema(JsonSchemaDescrip descrip, List<CommonProperty> propertyList) {
		...
		//鬼知道这里为什么报错 org.uboot.modules.system.model.DictModel cannot be cast to org.uboot.modules.system.model.DictModel
