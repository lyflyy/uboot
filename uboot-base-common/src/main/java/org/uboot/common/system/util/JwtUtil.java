package org.uboot.common.system.util;
...
public class JwtUtil {
	 ...
	 * @param request
	 * @return
	 * @throws UBootException
	 */
	public static String getUserNameByToken(HttpServletRequest request) throws UBootException {
		String accessToken = request.getHeader("X-Access-Token");
		String username = getUsername(accessToken);
		if (oConvertUtils.isEmpty(username)) {
			throw new UBootException("未获取到用户");
		}
		return username;
	}
